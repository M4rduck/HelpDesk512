...
<a type="button" class="btn btn-secondary btn-sm" href="{{route('home2')}}">Red</a>
<a type="button" class="btn btn-primary btn-sm" href="{{route('home')}}">Software</a>
<a type="button" class="btn btn-primary btn-sm" href="{{route('home3')}}">Hardware</a> <br>
<br>
<br>
    </div>
  </div>
